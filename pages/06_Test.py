...
Desempeño_Destacado = int(df[(df['desempenio'] == 'DesempeÃ±o Destacado')]['desempenio'].count())
Desempeño_Bueno = int(df[(df['desempenio'] == 'DesempeÃ±o Bueno')]['desempenio'].count())
Desempeño_Bajo = int(df[(df['desempenio'] == 'DesempeÃ±o Bajo')]['desempenio'].count())
